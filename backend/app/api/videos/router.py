...
def upload_and_analyze(
    ...
    log_action(
        db, AuditAction.VIDEO_UPLOADED, actor_id=current_user.id, actor_email=current_user.email,
        entity_type="VideoAnalysis", entity_id=analysis.id, detail=f"{analysis_type.value} ({original_name})",
    )
