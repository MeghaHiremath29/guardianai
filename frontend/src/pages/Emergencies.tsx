              ...
              <div>
                ...
                {selected.location_lat !== null && selected.location_lng !== null && (
                  <p className="mt-3 text-xs text-slate-500">
                    Location: <span className="font-mono text-slate-400">{selected.location_lat.toFixed(4)}, {selected.location_lng.toFixed(4)}</span>
                    {' — '}
                    <a
                      href={`https://www.openstreetmap.org/?mlat=${selected.location_lat}&mlon=${selected.location_lng}#map=16/${selected.location_lat}/${selected.location_lng}`}
                      target="_blank"
                      rel="noreferrer"
                    ...
                    <span className="block text-slate-600 mt-0.5">
                      Manually configured coordinates, not live GPS — see docs/architecture.md.
                    </span>
                  </p>
                )}
